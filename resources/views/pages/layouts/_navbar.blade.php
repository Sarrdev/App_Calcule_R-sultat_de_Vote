        ...
        <div class="d-flex align-items-left">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    <i class="mdi mdi-plus"></i> Ajouter un nouveau
                    <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                </button>
                <div class="dropdown-menu">

                    <!-- item-->
                    <a href="{{route('pages.create_candidat')}}" class="dropdown-item notify-item">
                        Candidat
                    </a>

                    <!-- item-->
                    <a href="{{route('pages.formregion')}}" class="dropdown-item notify-item">
                        Region
                    </a>

                    <!-- item-->
                    <a href="{{route('pages.formresult')}}" class="dropdown-item notify-item">
                        Résultat
                    </a>
